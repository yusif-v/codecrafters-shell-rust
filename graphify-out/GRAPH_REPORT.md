...
## Summary
- 39 nodes · 81 edges · 6 communities detected
- Extraction: 59% EXTRACTED · 41% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.8)
...
1. `run_builtin()` - 12 edges
2. `run_command()` - 12 edges
3. `run_pipeline()` - 10 edges
4. `find_executable()` - 6 edges
5. `main()` - 5 edges
6. `reap()` - 5 edges
7. `is_builtin()` - 4 edges
8. `reap_background_jobs()` - 4 edges
9. `parse_redirections()` - 4 edges
10. `emit()` - 4 edges

## Surprising Connections (you probably didn't know these)
- `run_builtin()` --calls--> `list()`  [INFERRED]
  src/builtins.rs → src/history.rs
...
Cohesion: 0.29
Nodes (6): reap_background_jobs(), add_job(), Job, JobSnapshot, JobStatus, reap()
...
- **Why does `run_builtin()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `run_command()` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `reap()` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Are the 6 inferred relationships involving `run_builtin()` (e.g. with `.new()` and `emit()`) actually correct?**
  _`run_builtin()` has 6 INFERRED edges - model-reasoned connections that need verification._
